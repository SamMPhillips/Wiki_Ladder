...
#include "parser.h"
    ...
    void UnitTests::testBuildWikiTree(){
        Vertex *test_root = new Vertex("https://en.wikipedia.org/wiki/Pittsburgh_Steelers");
        WikiTree test (test_root);
        Vertex *end = test.buildWikiTree("https://en.wikipedia.org/wiki/New_York_City");
        assert(end->getKey() == "https://en.wikipedia.org/wiki/New_York_City");
